...
final api = MudbaseSdk().getAuthenticationApi();
final ConfirmLocalPasswordResetWithOtpRequest confirmLocalPasswordResetWithOtpRequest = {"email":"user@example.com","projectId":"65f1a2b3c4d5e6f7a8b9c0d1","otp":"123456","newPassword":"NewSecurePass123!"}; // ConfirmLocalPasswordResetWithOtpRequest | 
...
final api = MudbaseSdk().getAuthenticationApi();
final CreateAnonymousSessionRequest createAnonymousSessionRequest = {"projectId":"65f1a2b3c4d5e6f7a8b9c0d1","deviceId":"device-uuid-123"}; // CreateAnonymousSessionRequest | 
...
final api = MudbaseSdk().getAuthenticationApi();
final LoginLocalUserRequest loginLocalUserRequest = {"email":"sarah.chen@example.com","password":"SecurePass123!","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"}; // LoginLocalUserRequest | 
...
final api = MudbaseSdk().getAuthenticationApi();
final RegisterLocalUserRequest registerLocalUserRequest = {"email":"sarah.chen@example.com","password":"SecurePass123!","firstName":"Sarah","lastName":"Chen","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"}; // RegisterLocalUserRequest | 
...
final api = MudbaseSdk().getAuthenticationApi();
final RequestLocalPasswordResetRequest requestLocalPasswordResetRequest = {"email":"user@example.com","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"}; // RequestLocalPasswordResetRequest | 
...
final ResetLocalPasswordRequest resetLocalPasswordRequest = {"password":"NewSecurePass123!","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"}; // ResetLocalPasswordRequest | 
...
final api = MudbaseSdk().getAuthenticationApi();
final MagicLinkRequest magicLinkRequest = {"email":"user@example.com","projectId":"65f1a2b3c4d5e6f7a8b9c0d1","redirectUrl":"https://app.example.com/auth/callback"}; // MagicLinkRequest | 
...
final api = MudbaseSdk().getAuthenticationApi();
final OTPSendRequest oTPSendRequest = {"email":"user@example.com","projectId":"65f1a2b3c4d5e6f7a8b9c0d1","method":"email"}; // OTPSendRequest | 
...
final api = MudbaseSdk().getAuthenticationApi();
final OTPVerifyRequest oTPVerifyRequest = {"identifier":"user@example.com","otp":"123456","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"}; // OTPVerifyRequest | 
