...
const DeviceRegisterRequestPlatformEnum
    _$deviceRegisterRequestPlatformEnum_unknown =
    const DeviceRegisterRequestPlatformEnum._('unknown');
...
DeviceRegisterRequestPlatformEnum _$deviceRegisterRequestPlatformEnumValueOf(
  ...
  switch (name) {
    ...
    case 'unknown':
      return _$deviceRegisterRequestPlatformEnum_unknown;
    default:
...
class _$DeviceRegisterRequest extends DeviceRegisterRequest {
  ...
  _$DeviceRegisterRequest._({required this.token, this.platform}) : super._();
  @override
    ...
    final _$result = _$v ??
        _$DeviceRegisterRequest._(
          token: BuiltValueNullFieldError.checkNotNull(
              token, r'DeviceRegisterRequest', 'token'),
          platform: platform,
        );
    replace(_$result);
    return _$result;
