...
import 'package:mudbase_sdk/src/model/health_response.dart';
import 'package:mudbase_sdk/src/model/system_status_response.dart';
...
class HealthApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SystemStatusResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SystemStatusResponse>> systemStatus({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    SystemStatusResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SystemStatusResponse),
