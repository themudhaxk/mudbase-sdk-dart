...
import 'package:mudbase_sdk/src/model/mcp_config_get200_response.dart';
...
class MCPApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [McpConfigGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<McpConfigGet200Response>> mcpConfigGet({ 
    ...
    McpConfigGet200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(McpConfigGet200Response),
      ) as McpConfigGet200Response;
    ...
    return Response<McpConfigGet200Response>(
      data: _responseData,
