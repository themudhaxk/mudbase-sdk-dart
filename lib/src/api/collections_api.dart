...
import 'package:mudbase_sdk/src/model/create_collection201_response.dart';
import 'package:mudbase_sdk/src/model/create_collection_request.dart';
import 'package:mudbase_sdk/src/model/list_collections200_response.dart';
import 'package:mudbase_sdk/src/model/message_response.dart';
import 'package:mudbase_sdk/src/model/update_collection_request.dart';
...
class CollectionsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateCollection201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateCollection201Response>> createCollection({ 
    ...
    final _path = r'/api/schemas/projects/{projectId}/collections'.replaceAll('{' r'projectId' '}', encodeQueryParameter(_serializers, projectId, const FullType(String)).toString());
    ...
    CreateCollection201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateCollection201Response),
      ) as CreateCollection201Response;
    ...
    return Response<CreateCollection201Response>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponse>> deleteCollection({ 
    required String projectId,
    ...
    final _path = r'/api/schemas/projects/{projectId}/collections/{collectionId}'.replaceAll('{' r'projectId' '}', encodeQueryParameter(_serializers, projectId, const FullType(String)).toString()).replaceAll('{' r'collectionId' '}', encodeQueryParameter(_serializers, collectionId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListCollections200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListCollections200Response>> listCollections({ 
    required String projectId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    ListCollections200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListCollections200Response),
      ) as ListCollections200Response;
    ...
    return Response<ListCollections200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [CreateCollection201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateCollection201Response>> updateCollection({ 
    required String projectId,
    required String collectionId,
