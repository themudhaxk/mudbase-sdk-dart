...
import 'package:mudbase_sdk/src/model/api_me_bootstrap_get200_response.dart';
import 'package:mudbase_sdk/src/model/change_password_request.dart';
import 'package:mudbase_sdk/src/model/disable2_fa_request.dart';
import 'package:mudbase_sdk/src/model/erase_user_data200_response.dart';
import 'package:mudbase_sdk/src/model/erase_user_data409_response.dart';
import 'package:mudbase_sdk/src/model/erase_user_data_request.dart';
import 'package:mudbase_sdk/src/model/error.dart';
import 'package:mudbase_sdk/src/model/export_user_data200_response.dart';
import 'package:mudbase_sdk/src/model/get_current_user200_response.dart';
import 'package:mudbase_sdk/src/model/list_o_auth_providers200_response.dart';
...
import 'package:mudbase_sdk/src/model/two_fa_setup_response.dart';
import 'package:mudbase_sdk/src/model/unlink_o_auth_provider200_response.dart';
import 'package:mudbase_sdk/src/model/update_user_profile200_response.dart';
import 'package:mudbase_sdk/src/model/update_user_request.dart';
import 'package:mudbase_sdk/src/model/verify2_fa_request.dart';
...
class UsersApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiMeBootstrapGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiMeBootstrapGet200Response>> apiMeBootstrapGet({ 
    ...
    final _path = r'/api/me/bootstrap';
    ...
    ApiMeBootstrapGet200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiMeBootstrapGet200Response),
      ) as ApiMeBootstrapGet200Response;
    ...
    return Response<ApiMeBootstrapGet200Response>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [MessageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponse>> disable2FA({ 
    ...
    final _path = r'/api/users/2fa/disable';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EraseUserData200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EraseUserData200Response>> eraseUserData({ 
    required EraseUserDataRequest eraseUserDataRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/users/me/erase';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(EraseUserDataRequest);
      _bodyData = _serializers.serialize(eraseUserDataRequest, specifiedType: _type);
    ...
    EraseUserData200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EraseUserData200Response),
      ) as EraseUserData200Response;
    ...
    return Response<EraseUserData200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ExportUserData200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExportUserData200Response>> exportUserData({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/users/me/export';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ExportUserData200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ExportUserData200Response),
      ) as ExportUserData200Response;
    ...
    return Response<ExportUserData200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCurrentUser200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCurrentUser200Response>> getCurrentUser({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetCurrentUser200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCurrentUser200Response),
      ) as GetCurrentUser200Response;
    ...
    return Response<GetCurrentUser200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> linkOAuthProvider({ 
    ...
    final _path = r'/api/users/me/oauth-providers/link/{provider}'.replaceAll('{' r'provider' '}', encodeQueryParameter(_serializers, provider, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListOAuthProviders200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListOAuthProviders200Response>> listOAuthProviders({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/users/me/oauth-providers';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ListOAuthProviders200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListOAuthProviders200Response),
      ) as ListOAuthProviders200Response;
    ...
    return Response<ListOAuthProviders200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [MessageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponse>> resendVerificationEmail({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/users/resend-verification';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TwoFASetupResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TwoFASetupResponse>> setup2FA({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/users/2fa/setup';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TwoFASetupResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TwoFASetupResponse),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UnlinkOAuthProvider200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UnlinkOAuthProvider200Response>> unlinkOAuthProvider({ 
    required String provider,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/users/me/oauth-providers/{provider}'.replaceAll('{' r'provider' '}', encodeQueryParameter(_serializers, provider, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    UnlinkOAuthProvider200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UnlinkOAuthProvider200Response),
      ) as UnlinkOAuthProvider200Response;
    ...
    return Response<UnlinkOAuthProvider200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateUserProfile200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateUserProfile200Response>> updateUserProfile({ 
    ...
    final _path = r'/api/users/update';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    UpdateUserProfile200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UpdateUserProfile200Response),
      ) as UpdateUserProfile200Response;
    ...
    return Response<UpdateUserProfile200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [MessageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponse>> verify2FA({ 
    ...
    final _path = r'/api/users/2fa/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [MessageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponse>> verifyEmail({ 
    ...
    final _path = r'/api/users/verify-email';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
